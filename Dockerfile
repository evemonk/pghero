FROM registry.docker.com/library/ruby:3.3.1-slim@sha256:25ee093f9d3405b4eb6c94b760160293314355c5255ef7974027d1d3d5a33e5f as base
...
RUN set -eux; \
    ...
    gem install bundler --version "2.5.10" --force ; \
    gem --version ; \
    bundle --version
