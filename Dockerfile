FROM registry.docker.com/library/ruby:3.3.0-slim@sha256:55bedb211dbc3bf2c0c1c7070ec0a21af633554dabdcc49a510bca9b100e0626 as base
...
RUN set -eux; \
    ...
    gem install bundler --version "2.5.9" --force ; \
    gem --version ; \
    bundle --version
