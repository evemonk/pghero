FROM registry.docker.com/library/ruby:3.3.3-slim@sha256:bc6372a998e79b5154c8132d1b3e0287dc656249f71f48487a1ecf0d46c9c080 as base
...
RUN set -eux; \
    ...
    gem install bundler --version "2.5.12" --force ; \
    gem --version ; \
    bundle --version
